...
package org.egov.eis.rowmapper;
...
public class PositionRowMapper implements RowMapper<Position> {
	@Autowired
	DepartmentDesignationService departmentDesignationService;
	...
	public Position mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		position.setIsPostOutsourced(rs.getBoolean("isPostOutsourced"));

		DepartmentDesignation deptdesig = departmentDesignationService.getDepartmentDesignationById(rs.getLong("deptdesig"));
