...
public class DepartmentDesignationRowMapper implements RowMapper<DepartmentDesignation> {
	...
	public DepartmentDesignation mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		Department department = departmentService.getDepartmentByCode(rs.getString("departmentid"));

		Designation designation = designationService.getDesignationByCode(rs.getString("designationid"));
